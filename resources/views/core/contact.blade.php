        ...
        <div class="col-12">
            <div class="text-center">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-2">
                    <button type="button" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-email-outline me-1"></i> Email us your question</button>
                    ...
                    <ul class="nav nav-pills navtab-bg">
                        <li class="nav-item">
                            <a href="#general-q-tab" data-bs-toggle="tab" aria-expanded="false" class="nav-link px-3 py-2 active">
                                <span class="me-1"><i class="mdi mdi-help-circle-outline"></i></span>
                        ...
                        <li class="nav-item">
                            <a href="#privacy-p-tab" data-bs-toggle="tab" aria-expanded="true" class="nav-link px-3 py-2">
                                <span class="me-1"><i class="mdi mdi-shield-half-full"></i></span>
                                <span class="d-none d-sm-inline-block">Privacy Policy</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#support-tab" data-bs-toggle="tab" aria-expanded="false" class="nav-link px-3 py-2">
                                <span class="me-1"><i class="mdi mdi-headset"></i></span>
